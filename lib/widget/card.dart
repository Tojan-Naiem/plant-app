          ...
          children: [
             ...
             Row( 
              ...
              children: [ 
                ...
                child: Text(widget.title!.toUpperCase(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400,fontSize: 12),),
                ),
             ...
             Padding(padding: const EdgeInsets.only(left: 5,top: 4),
             child: Text(widget.country!,style: TextStyle(color: Color(0xFF0C9869),fontWeight: FontWeight.normal),),
             )
